...
private _ec = effectiveCommander _unit;
...
private _target = "Land_Can_V3_F" createVehicle getPosATL _unit;
...
"COMBAT" or behaviour (effectiveCommander _unit) == "AWARE" or behaviour 
